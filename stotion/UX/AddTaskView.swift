        ...
        VStack(alignment: .leading) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                Button {
                    ...
                    DataStructure.tasks.append(task)
                    DataStructure.tasks = DataStructure.tasks.sorted { $0.dateAdded < $1.dateAdded }
                    //print(DataStructure.tasks[DataStructure.tasks.count - 1].taskName)
                    onAdd(task)
                    dismiss()
                } label: {
                    Text("Create Task")
